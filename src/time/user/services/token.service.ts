...
import { VerifyResetPasswordDto } from '@/time/user/dto/update-user.dto';
...
export class TokenService {
  ...
  async setPasswordResetState(user: User) {
    ...
    return {
      name: user.name,
      link: `${this.config.timeline.frontURL}/reset-password?reset-password-token=${password_reset_token}&user_id=${user.user_id}`,
    };
  }
